...
const Projects = () => {
      ...
      useEffect(() => {
          ...
          const projects = [
            {image: coffee, url: "https://coffee-frontend-liart.vercel.app", name: "Coffee website", description: "Coffee website with user friendly interface with dashboard", languages:[{language: "React"}, {language: "Django"}, {language: "Tailwind"} ]},
            ...
            {image: dolanan, url: "https://todolistdjosefprog-frontend.vercel.app", name: "Travel website", description: "Clear ui design and modern look!", languages:[{language: "React"}, {language: "Django"}, {language: "Tailwind"}]},
            {image: flowup, url: "https://todolistdjosefprog-frontend.vercel.app", name: "ToDoes", description: "Imagine a day where tasks are clear!", languages:[{language: "React"}, {language: "Django"}, {language: "Tailwind"}]},
          
          ]


      return(
            <section id="projects" className="max-w-[1200px] mx-auto mb-50">
                  ...
                  <div className="flex items-center justify-between p-4">
                        ...
                        <div className="flex items-center gap-3 font-bold cursor-pointer"> 
                              <h1>View all on GitHub</h1>
                              <a className="font-bold "><GoArrowUpRight size={20}/></a>
                        </div>
                  </div>
                  {/* Cards */}
                  <div className="relative grid grid-cols-1 md:grid-cols-2 gap-6 p-4 space-y-2 place-items-center">
                        {/* Card 1 */}
                        ...
                        <div key={key} className="flex flex-col justify-center bg-gradient-to-br from-[#0f1220] to-[#14182b] rounded-xl" data-aos="fade-right">
                              <a href={prev.url} className=" rounded-t-xl items-center">
                                    <img className="object-cover rounded-t-xl" src={prev.image} alt="" />
                              </a>
